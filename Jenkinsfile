    ...
    stages {
        ...
        stage('cd') {
            steps {
                ...
                dash 'docker compose -f docker-compose.yml -f docker-compose-${params.environment}.yml down --remove-orphans'
                dash 'docker compose -f docker-compose.yml -f docker-compose-${params.environment}.yml up -d --build'
